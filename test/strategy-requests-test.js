...
describe('Strategy', function() {
    ...
    describe('hanlding request with JWT provided by function', function() {
         var strategy;

        before(function(done) {
            strategy = new Strategy({secretOrKey: 'secret', tokenFunction: function(req) {
            ...
            chai.passport.use(strategy)
                ...
                .req(function(req) {
                    req.cookie = {};
                    req.cookie.token = test_data.valid_jwt.token;
                })
                .authenticate();
        });
